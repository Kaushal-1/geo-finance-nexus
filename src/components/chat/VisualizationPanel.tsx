...
const PlaceholderPanel = () => (
  <div className="flex h-full w-full flex-col items-center justify-center text-center text-gray-400">
    ...
    <h3 className="text-lg font-medium text-gray-300">Visualization Panel</h3>
    <p className="mt-2 max-w-xs">
      Ask questions about financial data to see visualizations appear here.
    </p>
  </div>
);
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-white/10 bg-black/20 p-4 backdrop-blur-sm">
        ...
        {activeVisualization.description && (
          <p className="mt-1 text-sm text-gray-400">{activeVisualization.description}</p>
        )}
      </div>
              ...
              <div className="h-full p-4">
                ...
                <Card className="h-full border-gray-800 bg-gray-900/70">
                  <CardHeader className="pb-2">
                    ...
                    {activeVisualization.chart.subtitle && (
                      <CardDescription>{activeVisualization.chart.subtitle}</CardDescription>
                    )}
                  </CardHeader>
                  <CardContent className="pb-6">
                    ...
                    {activeVisualization.chart.insights && (
                      <div className="mt-4 rounded-lg border border-teal-900/30 bg-teal-900/10 p-3">
              ...
              <Card className="h-full border-gray-800 bg-gray-900/70">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {activeVisualization.globalImpact ? (
                      activeVisualization.globalImpact.regions.map((region) => (
                        <div 
                          key={region.name} 
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div className={`px-2 py-1 rounded text-xs font-semibold ${
                              region.impact === 'High' ? 'bg-red-900/30 text-red-400' :
                              region.impact === 'Medium' ? 'bg-amber-900/30 text-amber-400' :
                      ...
                      <p className="text-gray-400">No global impact data available</p>
                    )}
                  </div>
                </CardContent>
              </Card>
