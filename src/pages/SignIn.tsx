      ...
      <div className="hidden md:flex md:w-3/5 relative flex-col items-center justify-center p-8">
        ...
        <div className="relative z-10 text-center max-w-xl">
          ...
          <div className="mt-12 space-y-6">
            <div className="glass-card p-4 text-left animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <p className="text-gray-300 italic">"GeoFinance revolutionized how we visualize market opportunities across regions."</p>
              <p className="text-teal text-sm mt-2">— Sarah Chen, Investment Strategist</p>
            </div>
            <div className="glass-card p-4 text-left animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <p className="text-gray-300 italic">"The geospatial insights helped us identify emerging market trends months ahead of competitors."</p>
              <p className="text-teal text-sm mt-2">— Marcus Johnson, Portfolio Manager</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-2/5 flex items-center justify-center p-4 md:p-8">
        <div className="glass-card w-full max-w-md p-8 rounded-xl border border-white/10 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 text-white bg-teal-gradient button-glow hover:brightness-110 transition-all"
              disabled={isLoading}
            >
            ...
            <div className="flex space-x-4">
              <button 
                type="button" 
                className="flex-1 flex items-center justify-center h-11 rounded-md border border-white/10 bg-black/20 hover:bg-black/40 transition-colors"
                disabled={isLoading}
              >
