...
export const faqData: Record<string, FAQCategoryData> = {
  technology: {
    ...
    description: "Explore how GeoFinance leverages cutting-edge technologies to provide unparalleled financial insights through geospatial visualization.",
    questions: [
      {
        question: "How does GeoFinance leverage the Perplexity SONAR API?",
        answer: "GeoFinance utilizes SONAR's advanced AI capabilities to extract and analyze financial data from millions of sources, enabling real-time market sentiment analysis and trend prediction with unprecedented accuracy.",
      ...
      {
        question: "What mapping technologies power GeoFinance's visualization layer?",
      ...
      {
        question: "How does GeoFinance ensure data reliability and accuracy?",
      ...
      {
        question: "What is the architecture behind GeoFinance's platform?",
        answer: "GeoFinance employs a modern React frontend with TypeScript and Tailwind CSS, coupled with a robust serverless backend using Supabase for authentication, database, and edge functions that process financial data.",
      ...
      {
        question: "How scalable is GeoFinance's technological infrastructure?",
  ...
  design: {
    ...
    description: "Discover how GeoFinance blends aesthetics with functionality to create an intuitive, powerful platform for financial analysis.",
    questions: [
      {
        question: "How does GeoFinance's UI/UX enhance financial decision-making?",
        ...
        details: "User studies show that analysts using GeoFinance identify market opportunities 47% faster than with traditional dashboards, with a 92% satisfaction rate on information accessibility and visual clarity.",
      ...
      {
        question: "What principles guide GeoFinance's interface design?",
      ...
      {
        question: "How does GeoFinance balance information density with usability?",
      ...
      {
        question: "How responsive is GeoFinance across different devices?",
        answer: "GeoFinance employs a 'mobile-first, desktop-optimized' approach with tailored experiences for each platform. Financial visualizations dynamically adapt to available screen real estate while maintaining data integrity.",
      ...
      {
        question: "How does GeoFinance incorporate user feedback into design iterations?",
  ...
  impact: {
    ...
    description: "Learn how GeoFinance is transforming financial analytics and creating positive change across markets and communities.",
    questions: [
      {
        question: "How does GeoFinance democratize access to financial intelligence?",
      ...
      {
        question: "What economic inefficiencies does GeoFinance help resolve?",
        answer: "By surfacing regional market patterns traditionally hidden in aggregate data, GeoFinance helps identify overlooked investment opportunities in emerging markets and local economies, reducing information asymmetry.",
      ...
      {
        question: "How does GeoFinance benefit developing markets and regions?",
      ...
      {
        question: "What environmental or social benefits does GeoFinance enable?",
        answer: "GeoFinance includes ESG (Environmental, Social, Governance) data overlays that allow investors to visualize the impact of their investments beyond financial returns, promoting sustainable and ethical investing.",
      ...
      {
        question: "How does GeoFinance improve financial literacy globally?",
        ...
        details: "Educational institutions using GeoFinance report a 72% improvement in student comprehension of market dynamics compared to traditional teaching methods, with engagement metrics showing 3.7x longer study sessions.",
      }
    ]
  },
  idea: {
    title: "Quality of the Idea",
    description: "Understand what makes GeoFinance's approach unique in financial technology and how it reimagines market analysis.",
    questions: [
      {
        question: "What was the inspiration behind GeoFinance's concept?",
        answer: "GeoFinance was born from the realization that financial data has inherent geographical dimensions that traditional analytics platforms ignore. By visualizing this spatial component, we reveal patterns invisible in conventional charts and tables.",
      ...
      {
        question: "How novel is GeoFinance's approach to financial analysis?",
        answer: "While geospatial visualization exists in some specialized financial tools, GeoFinance is the first platform to seamlessly integrate real-time market data, AI-powered sentiment analysis, and interactive geographic visualization in a unified experience.",
      ...
      {
        question: "How does GeoFinance improve upon existing solutions?",
        answer: "Traditional financial platforms present data as charts and tables, divorced from geographic context. GeoFinance contextualizes this data spatially, revealing correlations between regions and markets that would otherwise remain hidden.",
        details: "Comparative testing shows users identify inter-market correlations 58% faster and with 43% greater accuracy using GeoFinance compared to leading financial terminals, with particular advantages in detecting supply chain disruptions and regional market shifts.",
      },
      {
        question: "What are the most innovative features of GeoFinance?",
      ...
      {
        question: "What is the future vision for GeoFinance?",
  ...
  market: {
    ...
    description: "Discover GeoFinance's approach to market penetration, business model, and scaling strategy.",
    questions: [
      {
        question: "Who is GeoFinance's target audience?",
      ...
      {
        question: "What is GeoFinance's business model?",
      ...
      {
        question: "How will GeoFinance scale its user base?",
      ...
      {
        question: "How does GeoFinance plan to stay ahead of competitors?",
      ...
      {
        question: "What are the key metrics GeoFinance uses to measure success?",
        ...
        details: "Our success metrics are directly tied to user outcomes. We measure how GeoFinance reduces the time to make investment decisions (currently -42%) and increases confidence in those decisions (currently +67%) compared to other tools.",
        metrics: [
